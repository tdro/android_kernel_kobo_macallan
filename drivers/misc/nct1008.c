...
static int nct1008_read_manufacture_id(struct nct1008_data *data)
{
	struct i2c_client *client = data->client;
	manufacture_id = nct1008_read_reg(client, MANUFACTURE_ID_RD);
	printk("nct1008: manufacutre_id = %x", manufacture_id);
				...
				const struct i2c_device_id *id)
{
	...
	nct1008_read_manufacture_id(data);
