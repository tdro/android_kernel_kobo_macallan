...
static bool charger_enable = false;
bool check_external_charger(void) 
{
	if (charger_enable)
		return true;
	else
...
EXPORT_SYMBOL(check_external_charger);
...
#ifdef CONFIG_PM
int otg_suspend_flag = 0;
EXPORT_SYMBOL(otg_suspend_flag);
