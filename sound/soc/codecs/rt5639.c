...
//	{RT5639_HP_CALIB_AMP_DET, 0x0420},
	...
	{RT5639_SPK_VOL		, 0x8c8c},//SPKMIX -> SPKVOL
...
//	{RT5639_REC_R2_MIXER	, 0x006f},//Mic2 -> RECMIXR
	...
	{RT5639_PRIV_INDEX	, RT5639_EQ_FC_HIP1},//PRae
	{RT5639_PRIV_DATA	, 0x1df8},	
	{RT5639_DRC_AGC_1 	, 0x6206},//0xb4
	{RT5639_DRC_AGC_2	, 0x1d03},//0xb5
...
PR-B4=0FF6
*/
		rt5639_index_write(codec, 0xb3, 0x0402);
		rt5639_index_write(codec, 0xb4, 0x0ff6);	
		...
		snd_soc_update_bits(codec, RT5639_EQ_CTRL2,
			RT5639_EQ_HPF1_MASK | RT5639_EQ_HPF1_M_MASK,
			RT5639_EQ_HPF1_EN | RT5639_EQ_HPF1_M_1ST);	
		break;
	...
	case SND_SOC_DAPM_PRE_PMD:
		...
		snd_soc_write(codec, RT5639_EQ_CTRL2, 0x0);
		break;
