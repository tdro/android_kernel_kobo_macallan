...
static struct tegra11_emc_table titan_hynix_2g_h5tc4g63afr_pba_T40S_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
	...
	},
	{
		...
		11,         /* number of up_down_regs */
		{
			...
			0x00038000, /* EMC_DLI_TRIM_TXDQS4 */
			0x00038000, /* EMC_DLI_TRIM_TXDQS5 */
			0x00038000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00038000, /* EMC_DLI_TRIM_TXDQS7 */
			0x001112a0, /* EMC_XM2CMDPADCTRL */
			0x00000000, /* EMC_XM2CMDPADCTRL4 */
			0x0001013d, /* EMC_XM2DQSPADCTRL2 */
			0x00000000, /* EMC_XM2DQPADCTRL2 */
		...
		},
		{
			...
			0x00038000, /* EMC_DLI_TRIM_TXDQS0 */
			...
			0x00038000, /* EMC_DLI_TRIM_TXDQS1 */
			0x00038000, /* EMC_DLI_TRIM_TXDQS2 */
			0x00038000, /* EMC_DLI_TRIM_TXDQS3 */
...
static struct tegra11_emc_table titan_nanya_2g_nt5cc256m16cp_di_T40S_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_pdata titan_hynix_2g_h5tc4g63afr_pba_T40S_pdata = {
	.description = "titan_hynix_2g_h5tc4g63afr_pba_T40S",
	.tables = titan_hynix_2g_h5tc4g63afr_pba_T40S_table,
	.num_tables = ARRAY_SIZE(titan_hynix_2g_h5tc4g63afr_pba_T40S_table),
};

static struct tegra11_emc_pdata titan_nanya_2g_nt5cc256m16cp_di_T40S_pdata = {
	.description = "titan_nanya_2g_nt5cc256m16cp_di_T40S",
	.tables = titan_nanya_2g_nt5cc256m16cp_di_T40S_table,
	.num_tables = ARRAY_SIZE(titan_nanya_2g_nt5cc256m16cp_di_T40S_table),
};
...
{
	switch (odm_info.ddr_sku) {
	case SKU_NT5CC256M16CP_DI:
		return &titan_nanya_2g_nt5cc256m16cp_di_T40S_pdata;
	case SKU_H5TC4G63AFR_PBA:
		return &titan_hynix_2g_h5tc4g63afr_pba_T40S_pdata;
	}
...
int __init macallan_emc_init(void)
{
	...
	/* Elpida & Micron are not supported yet */
	if (odm_info.ddr_sku != SKU_H5TC4G63AFR_PBA &&
		odm_info.ddr_sku != SKU_NT5CC256M16CP_DI)
		return 0;
