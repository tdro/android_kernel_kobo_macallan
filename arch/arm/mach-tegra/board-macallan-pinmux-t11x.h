...
static __initdata struct tegra_pingroup_config macallan_pinmux_common_evt[] = {
	...
	/* BLINK pinmux */
	DEFAULT_PINMUX(CLK_32K_OUT,   BLINK,       PULL_UP,   NORMAL,   INPUT),
	...
	/* GPIO pinmux */
	GPIO_PINMUX(GPIO_X4_AUD, NORMAL, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_AD12, PULL_UP, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD13, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD14, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD15, NORMAL, NORMAL, OUTPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_CS6_N, NORMAL, NORMAL, INPUT, DISABLE),
...
static __initdata struct tegra_pingroup_config macallan_pinmux_common_dvt1[] = {
	...
	GPIO_PINMUX(GPIO_X7_AUD, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GPIO_W3_AUD, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(DAP3_FS, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GPIO_PBB3, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_A18, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD10, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD11, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD12, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD13, NORMAL, NORMAL, INPUT, DISABLE),
	...
	GPIO_PINMUX(GMI_RST_N, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_WAIT, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(CLK2_REQ, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(SDMMC1_WP_N, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(KB_COL0, PULL_UP, NORMAL, INPUT, DISABLE),
...
static __initdata struct tegra_pingroup_config macallan_pinmux_common[] = {
	...
	GPIO_PINMUX(GMI_AD10, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD12, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_AD13, PULL_UP, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD4, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD5, NORMAL, NORMAL, INPUT, DISABLE),
	GPIO_PINMUX(GMI_AD8, NORMAL, NORMAL, OUTPUT, DISABLE),
	GPIO_PINMUX(GMI_ADV_N, PULL_UP, NORMAL, INPUT, DISABLE),
...
static __initdata struct tegra_pingroup_config unused_pins_lowpower_evt[] = {
	...
	UNUSED_PINMUX(SDMMC3_CLK_LB_OUT),
	UNUSED_PINMUX(SDMMC3_CLK_LB_IN),
...
static __initdata struct tegra_pingroup_config unused_pins_lowpower_dvt1[] = {
	UNUSED_PINMUX(CLK1_REQ),
	UNUSED_PINMUX(DAP1_DIN),
	UNUSED_PINMUX(DAP1_DOUT),
	UNUSED_PINMUX(DAP1_FS),
...
static struct gpio_init_pin_info init_gpio_mode_macallan_common_evt[] = {
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PX4, true, 0),
...
static struct gpio_init_pin_info init_gpio_mode_macallan_common_dvt1[] = {
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PX7, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PW3, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PP0, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PBB3, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PB1, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH2, false, 1),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH3, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH4, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PH5, true, 0),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PS1, false, 1),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PEE1, false, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PU5, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PU6, true, 0),
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PN7, true, 0),
