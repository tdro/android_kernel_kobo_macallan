...
static __initdata struct tegra_clk_init_table wifi_clk_init_table_evt[] = {
	/* name         parent          rate            enabled */
	{ "blink",      "clk_32k",      32768,          true},
	{ NULL,         NULL,           0,              0},
};

static __initdata struct tegra_clk_init_table wifi_clk_init_table_dvt1[] = {
	/* name         parent          rate            enabled */
...
static int __init macallan_wifi_init(void)
{
	...
	if (odm_info.pcb_ver == PCB_EVT) {
		tegra_clk_init_from_table(wifi_clk_init_table_evt);
	}
	else if (odm_info.pcb_ver == PCB_DVT1) {
		tegra_clk_init_from_table(wifi_clk_init_table_dvt1);
	}
